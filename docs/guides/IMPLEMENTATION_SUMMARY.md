...
**Location:** `src/llm_rag_event_discovery_pipeline/weaviate_client.py` → `is_duplicate()`, `_is_duplicate_with_llm()`
...
**Location:** `src/llm_rag_event_discovery_pipeline/weaviate_client.py` → `cleanup_past_events()`
